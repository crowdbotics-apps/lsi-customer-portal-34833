...
## Project Structure
    ...
    ├── lsi_customer_portal_34833  # Django project configurations
...
1. Clone this repo and `cd lsi_customer_portal_34833`
...
2. Clone this repo and `cd lsi_customer_portal_34833`
